...
function Hero() {
  ...
  return (
    <div className="Hero">
      <img className="hero-logo" src={logo} width="350px" alt="logo" />
      <div className="scroll-indicator">
        <div className="scroll-indicator-wrapper">
          <span className="dot" style={{ top: yAxis, opacity: opacity }}></span>
        </div>
        <p>
          <i>scroll down</i>
        </p>
      ...
      <div className="bottom-hero">
        <div className="bottom-left">
          ...
          <ul>
            <li>
              <img src={toast} width="50px" alt="toast" />
            </li>
            <li>
              <img src={doordash} width="25px" alt="doordash" />
            </li>
            <li>
              <img src={postmates} width="25px" alt="postmates" />
            </li>
          </ul>
        </div>
